...
public class REOKPSPublicSoap12
{
    ...
    public REOKPSPublicSoap12()
    {
    }

    public REOKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public REOKPSPublicSoap12 (String url,REOConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        REORequestResultHandler handler = new REORequestResultHandler(REOSoapVersion.v1_2);
        return handler;
    }
